    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <Badge variant={settings.maintenance_mode ? "secondary" : "outline"}>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                <Label className="text-base font-medium">User Login Access</Label>
              ...
              <Switch
                ...
                onCheckedChange={(checked) => handleSettingChange('login_enabled', checked)}
              />
            </div>
      ...
      {(!settings.login_enabled || settings.maintenance_mode) && (
        ...
        >
          <Alert>
            <AlertTriangle className="h-4 w-4" />
            <AlertDescription>
              <strong>Warning:</strong> {!settings.login_enabled && 'User login is currently disabled. '}
