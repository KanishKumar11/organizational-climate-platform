...
export default function NotificationSettingsPage() {
  ...
  const handleSettingChange = (category: keyof typeof settings, key: string, value: boolean) => {
    setSettings(prev => ({
      ...prev,
      [category]: {
        ...prev[category],
      ...
      <DashboardLayout>
        <div className="flex items-center justify-center h-64">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Please sign in to view notification settings.</p>
          </div>
        </div>
      </DashboardLayout>
    );
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="text-center p-4 bg-blue-50 rounded-lg">
                ...
                <div className="text-sm text-blue-700">Email notifications enabled</div>
              </div>
              <div className="text-center p-4 bg-green-50 rounded-lg">
                ...
                <div className="text-sm text-green-700">In-app notifications enabled</div>
              </div>
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                ...
                <div className="text-sm text-gray-700">Push notifications enabled</div>
              </div>
            </div>
          </CardContent>
        </Card>
