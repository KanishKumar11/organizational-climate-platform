...
SurveyDistributionSchema.methods.regenerateQR = async function(userId: mongoose.Types.ObjectId) {
...
// Track access
SurveyDistributionSchema.methods.trackAccess = async function(isUnique: boolean = false) {
...
// Generate public URL
SurveyDistributionSchema.methods.generatePublicURL = function(baseUrl: string): string {
...
export default mongoose.models.SurveyDistribution || 
  mongoose.model<ISurveyDistribution>('SurveyDistribution', SurveyDistributionSchema);
