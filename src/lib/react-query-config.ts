...
export const queryKeys = {
  ...
  companies: {
    ...
    departments: (id: string) => [...queryKeys.companies.detail(id), 'departments'] as const,
    users: (id: string) => [...queryKeys.companies.detail(id), 'users'] as const,
  },
  ...
  surveys: {
    ...
    list: (filters: string) => [...queryKeys.surveys.lists(), { filters }] as const,
    details: () => [...queryKeys.surveys.all, 'detail'] as const,
    detail: (id: string) => [...queryKeys.surveys.details(), id] as const,
    responses: (id: string) => [...queryKeys.surveys.detail(id), 'responses'] as const,
    results: (id: string) => [...queryKeys.surveys.detail(id), 'results'] as const,
    drafts: ['surveys', 'drafts'] as const,
    draft: (sessionId: string) => [...queryKeys.surveys.drafts, sessionId] as const,
  },
  
  // Question Library
  questionLibrary: {
    all: ['question-library'] as const,
    questions: (filters: string) => [...queryKeys.questionLibrary.all, 'questions', { filters }] as const,
    categories: () => [...queryKeys.questionLibrary.all, 'categories'] as const,
    popular: (limit: number) => [...queryKeys.questionLibrary.all, 'popular', limit] as const,
  },
  ...
  departments: {
    ...
    list: (companyId: string) => [...queryKeys.departments.lists(), companyId] as const,
